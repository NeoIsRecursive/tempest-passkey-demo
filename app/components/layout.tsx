...
export const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <footer className="border-t p-6 m-6 flex justify-between items-center">
        <Button asChild variant="ghost" size="lg">
          <a href="https://github.com/NeoIsRecursive">
            <CopyrightIcon />
            Neo Lejondahl
          </a>
        </Button>
        <Button asChild variant="ghost" size="icon-lg">
          <a href="https://github.com/NeoIsRecursive/tempest-passkey-demo">
            <svg
              role="img"
              viewBox="0 0 24 24"
